...
//
// Class for validation of the user. Validates that all
// the parameters within JSON strings adhere to requirements
// of the UserController in order for  the user to be stored
// permanently by UserStorer class
